...
# Pvec is the vector of probabilities predicted by your model
# Cvec is the vector of 0's and 1's indicating the realized classifications of each observation.
